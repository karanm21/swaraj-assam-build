  ...
  return (
    <section id="about" className="section-padding relative">
      <div className="container mx-auto px-4 relative z-10">
        {/* Header Section with opaque background */}
        <div className="text-center mb-16 bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
        ...
        {/* Main Content Grid with opaque backgrounds */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
          ...
          {/* Right Stats with opaque background */}
        ...
        {/* Features Grid with opaque background */}
        <div className="bg-white/95 backdrop-blur-sm rounded-xl p-8 shadow-lg mb-12">
        ...
        {/* Call to Action with opaque background */}
        <div className="text-center bg-white/95 backdrop-blur-sm rounded-xl p-8 shadow-lg">
          <Link to="/about">
